...
* **Nix / devenv / devbox / mise** — genuinely reproducible without containers.
  Rejected: steep ramp-up, and no path to a hosted environment. This rejection
  is about replacing the container. mise is used *inside* the container to
  manage project tools; see ADR 0002.
